namespace TruckCheckUp.DataAccess.SQL.Migrations
{
    ...
    public partial class Initial : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.String(nullable: false, maxLength: 128),
                        SituationId = c.String(maxLength: 128),
                        PartInspectedId = c.String(maxLength: 128),
                        CreationDate = c.DateTimeOffset(nullable: false, precision: 7),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.PartsInspecteds", t => t.PartInspectedId)
                .ForeignKey("dbo.Situations", t => t.SituationId)
                .Index(t => t.SituationId)
                .Index(t => t.PartInspectedId);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.PartSituations", "SituationId", "dbo.Situations");
            DropForeignKey("dbo.PartSituations", "PartInspectedId", "dbo.PartsInspecteds");
            ...
            DropIndex("dbo.PartSituations", new[] { "PartInspectedId" });
            DropIndex("dbo.PartSituations", new[] { "SituationId" });
